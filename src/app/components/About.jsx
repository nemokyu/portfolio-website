...
const AboutSection = () => {
  ...
  return (
    <section className=" proj-relative text-white " id="about" >
      <div className="md:grid md:grid-cols-6 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="col-span-4 mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base text-[#ADB7BE] font-mononoki relatove">
              When I&apos;m not studying or coding, I like to do calligraphy, doodle, nail art, and crochet. If I&apos;m not at my desk I like to run, play volleyball, thrift, photography
              and film/edit Youtube videos. <a href="https://www.youtube.com/channel/UCURQfb9WfX33dvFcIYrN_nw" className="text-[#93A5CF] hover:text-white"><u>Check out my Youtube!</u></a>
          </p>
          <div className="hidden xl:block absolute bottom-2 transform translate-x-1/2 bg-gradient-to-t from-blue-900 via-transparent to-transparent rounded-full h-80 w-80 blur-lg"></div>
